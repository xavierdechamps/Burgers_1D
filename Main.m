...
Filter            = 4     % Dynamic Smagorinsky model: type of filter
...
Time_steps        = 50000   % Number of time steps, increment in time is thus equal to Time_total/Time_steps
...
Name_output       = 'LagrangeP3_7.5e-3_64_C0.2' % Name of the output file
...
switch method
  case 1
     FE_LagrangeP1(Number_elements,Viscosity,Subgrid_constant,Filter,Length_domain,Time_total,Time_steps,Name_output,Name_spectrum_ref);
  ...
  case 8
     FD_compact_spectral (Number_elements,Viscosity,Subgrid_constant,Filter,Length_domain,Time_total,Time_steps,Name_output,Name_spectrum_ref,submethod) ;
