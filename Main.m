...
Name_output       = 'DGFE_HermiteH3_3.5e-3_1024' % Name of the output file
...
switch method
  ...
  case 6
     DGFE_HermiteH3(Number_elements,Viscosity,Subgrid_constant,Filter,Alpha_Pade,M_DGFE,Length_domain,Time_total,Time_steps,Ninterpolation,Name_output,Name_spectrum_ref);
