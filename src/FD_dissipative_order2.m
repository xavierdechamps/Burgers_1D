function FD_dissipative_order2 (N,nu,constant_sub,filter,Alpha_Pade,L,time,nbrpointtemp,name,file_spectrum)
...
%******** Call Runge-Kutta and compute kinematic energy ********
    [u(:,z),dynamic_smag_constant(i-1)] = ...
              RK4_FD_dissipative_order2 (u(:,z-1),deltat,N,nu,F,h,constant_sub,ind,filter,Alpha_Pade ,mat_alpha);
...
function [y,smag_sub] = RK4_FD_dissipative_order2 (u,deltat,N,nu,F,h,constant_sub,ind,filter,alpha,mat_alpha)
