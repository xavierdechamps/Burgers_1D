...
%   k1 = -mat_deriv1\vec_deriv1 + mat_deriv2\vec_deriv2;
...
%   k2 = -mat_deriv1\vec_deriv1 + mat_deriv2\vec_deriv2;
...
%   k3 = -mat_deriv1\vec_deriv1 + mat_deriv2\vec_deriv2;
  Un4 = Un+deltat*k3;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Fifth step
...
%   k4 = -mat_deriv1\vec_deriv1 + mat_deriv2\vec_deriv2;
...
% Compute the first spatial derivative with a compact finite difference scheme, in the divergent form
...
% Compute the numerical energy produced by the spatial discretization of the convective term
  energy = 0;
