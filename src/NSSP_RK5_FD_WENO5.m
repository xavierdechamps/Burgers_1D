function y = NSSP_RK5_FD_WENO5 (u,deltat,N,K,F,h,constant_sub)
% Temporal integration of the 1D Burgers equation with an explicit 
% 5 steps non-strong-stability-preserving Runge-Kutta scheme (NSSP5)
% see Linear Instability of the Fifth-Order WENO Method, Rong Wang and Raymond J Spiteri, 2007
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Fifth step
  ...
  k4 = K * Un4 + C;
  Un5 = Un + deltat * k4 *2/3;
  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Sixth step
  C   = get_non_linear_WENO5(Un5,ind,N,h) ;
  k5 = K * Un5 + C;
  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  y  = Un + deltat*(k1 + 3*k5 )*0.25 + F;
